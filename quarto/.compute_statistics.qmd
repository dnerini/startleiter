...
ax = sns.scatterplot(x=dfg.index, y=dfg.values, marker="x", ax=axs[0])
ax.set(ylabel="No. flights per day")
ax = sns.scatterplot(x="datetime", y="max_altitude_m", marker="x", data=dfs, ax=axs[1])
ax = sns.scatterplot(x="datetime", y="length_km", marker="x", data=dfs, ax=axs[2])
ax = sns.scatterplot(x="datetime", y="airtime_hours", marker="x", data=dfs, ax=axs[3])
